...
fallzahlen_BL = fallzahlen_df.groupby(key_list_BL, as_index=False, observed=True).agg(agg_key)
...
fallzahlen_00 = fallzahlen_df.groupby(key_list_00, as_index=False, observed=True).agg(agg_key)
